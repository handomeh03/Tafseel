...
export default function StoreOrdersPage() {
  ...
  const closeDetailsModal = useCallback(() => setSelectedOrder(null), []);
  const closeEditStatusModal = useCallback(() => setOrderToEditStatus(null), []);
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">
            متابعة وإدارة الطلبات الموجهة لمتجرك وتحديث حالة تجهيزها وشحنها للزبائن.
          </p>
        </div>
      </div>
